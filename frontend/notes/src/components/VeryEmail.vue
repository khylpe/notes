<template>
       <a-card hoverable style="width: 300px">
              <template #cover>
                     <img src="@/assets/2.png" alt="Mail image by ChatGPT/DALL-E">
              </template>
              <template #actions>
                     ...
                     <a-popover placement="bottom" trigger="click" title="Profil settings">
                            <template #content>
                                   ...
                                   <a-form :model="formState" name="normal_login"
                                          class="login-form flex flex-row items-center justify-between" @finish="onFinish"
                                          ...
                                          <div class="flex justify-center">
                                                 ...
                                                 <a-form-item v-if="!isInputUsernameDisabled">
                                                        <a-button class="login-form-button" type="text" html-type="submit">
...
const emit = defineEmits(['refreshApp']);
...
const onRefreshClicked = () => {
       ...
       emit('refreshApp'); // Emit the refresh event
};
