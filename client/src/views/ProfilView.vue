                     ...
                     <a-tab-pane key="information" tab="Main information">
                            ...
                            <div class="flex flex-col md:flex-row md:items-center mt-6">
                                   ...
                                   <div class="flex flex-row mt-3">
                                          <a-avatar v-if="profilPicture" class="ml-3"
                                                 style="width: 100px; height: 100px;" :src="profilPicture" />
                            ...
                            <a-button class="mt-20" :disabled="!isProfileModified" @click="onSaveProfile"
                                   type="primary">Save
                                   profil</a-button>
                     </a-tab-pane>
